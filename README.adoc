...
To run it in _development_ mode invoke make sure you are in the +combined+ folder. Then invoke:
...
Running this application is most convenient for development since it requires only one process to be started.
