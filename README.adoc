...
* In the top folder execute +./gradlew installTemplateOpenDolphin+ which will install the +opendolphin+ template into +~/.lazybones/templates/opendolphin-0.0.5.zip+
* In an arbitrary directory execute +lazybones create opendolphin 0.0.5 hello_dolphin+ which will create the folder +hello_dolphin+ and expand the template into it.
